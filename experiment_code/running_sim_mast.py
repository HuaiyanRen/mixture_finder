...
def running_tuple(tuple_list):
    ...
    #run
    cmd = '/usr/bin/time -v /scratch/dx61/hr8997/software/iqtree-2.3.5.onnxupdate-Linux-intel/bin/iqtree2 -s ' + file_name + '.fa -m MIX+MFP -mrate E,I,G,I+G,R,I+R -pre all/'+ file_name + ' -nt 1'
    result = subprocess.run(cmd, shell=True, text=True, capture_output=True)
    with open('all/' + file_name + '_time.txt', 'a+') as f:
