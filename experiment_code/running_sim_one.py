...
def running_tuple(tuple_list):
    ...
    cmd = '/usr/bin/time -v /scratch/dx61/hr8997/software/iqtree-2.3.5.onnxupdate-Linux-intel/bin/iqtree2 -s ' + file_name + '.fa -m MFP -mfreq FO -mrate E,I,G,I+G,R,I+R -pre one/'+ file_name + ' -nt 1'
