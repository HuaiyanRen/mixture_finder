...
def running_tuple(tuple_list):
    ...
    if os.path.isfile('all/'+ file_name + '.iqtree'): 
        ...
        cmdm = '/scratch/te06/hr8997/software/iqtree-2.2.2.7.modelmix-Linux/bin/iqtree2 -rf ' + treem + ' ' + tree0 + ' -pre all/' + file_name + '_rf -redo -nt 1'
        os.system(cmdm)
        
    if os.path.isfile('one/'+ file_name + '.iqtree'):
        tree1 = 'one/'+ file_name + '.treefile'
        cmd1 = '/scratch/te06/hr8997/software/iqtree-2.2.2.7.modelmix-Linux/bin/iqtree2 -rf ' + tree1 + ' ' + tree0 + ' -pre one/' + file_name + '_rf -redo -nt 1'
        os.system(cmd1)
        
    if os.path.isfile('gtr/'+ file_name + '.iqtree'): 
        treeg = 'gtr/'+ file_name + '.treefile'
        cmdg = '/scratch/te06/hr8997/software/iqtree-2.2.2.7.modelmix-Linux/bin/iqtree2 -rf ' + treeg + ' ' + tree0 + ' -pre gtr/' + file_name + '_rf -redo -nt 1'
        os.system(cmdg)
